...
module.exports = (app, passport) => {
  ...
  app.get('/restaurants/top', authenticated, restController.getTop10restaurant)
  ...
  app.get('/users/top', authenticated, userController.getTopUser) //放在  app.get('/users/:id')前面
